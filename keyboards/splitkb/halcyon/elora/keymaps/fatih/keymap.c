 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     OSM(MOD_LSFT),  KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,            KC_B , OSM(MOD_LSFT), HYPR(KC_5),     MACLOCK , KC_ESC, KC_N,   KC_M ,  KC_COMM, KC_DOT,  KC_SLSH, OSM(MOD_RSFT),
                                OSM(MOD_ALT), KC_LEFT , KC_RIGHT,  KC_LGUI, KC_BSPC,                    KC_ENT ,LT(_SYMBOLS, KC_SPC), KC_DOWN, KC_UP, OSM(MOD_RALT), KC_MUTE, KC_NO,  KC_NO, KC_NO, KC_NO,                                                                KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO),

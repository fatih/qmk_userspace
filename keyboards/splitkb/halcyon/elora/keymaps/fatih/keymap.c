 ...
 * |--------+------+------+------+------+------+-------------.  ,-------------+------+------+------+------+------+--------|
 * | LSHIFT |   Z  |   X  |   C  |   V  |   B  | Shift|HYP 5|  | Lock | ESC  |   N  |   M  | ,  < | . >  | /  ? | RSHIFT |
 * `----------------------+------+------+------+------+------|  |------+------+------+------+------+----------------------'
 *                        | Lalt | Left | Right| GUI  | Bpsc |  | Enter| Space| Down | Up   | Ralt |
 *                        |      |      |      |      |      |  |      |      |      |      |      |
 *                        `----------------------------------'  `----------------------------------'
 * ,-----------------------------------.                                              ,-----------------------------------.
 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     OSM(MOD_LSFT),  KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,            KC_B , OSM(MOD_LSFT), HYPR(KC_5),     MACLOCK , KC_ESC, KC_N,   KC_M ,  KC_COMM, KC_DOT,  KC_SLSH, OSM(MOD_RSFT),
                                OSM(MOD_LALT), KC_LEFT , KC_RIGHT,  KC_LGUI, KC_BSPC,                    KC_ENT ,LT(_SYMBOLS, KC_SPC), KC_DOWN, KC_UP, OSM(MOD_RALT), KC_MUTE, KC_NO,  KC_NO, KC_NO, KC_NO,                                                                KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO),
 ...
 */
    [_NUMPAD] = LAYOUT_elora_hlc(
      _______, UG_TOGG, UG_NEXT, UG_PREV, RM_TOGG, RM_NEXT,                                     _______, _______, _______, _______, _______, QK_BOOT,
      _______, _______, _______, _______, _______, _______,                                     KC_COLN, KC_KP_7, KC_KP_8, KC_KP_9, KC_KP_ASTERISK, _______,
      ...
      _______, _______, _______, _______, _______, _______, _______, _______,  _______, _______,KC_DOT, KC_KP_1, KC_KP_2, KC_KP_3, KC_SLSH, _______,
                                 _______, _______, KC_NO, KC_SPC, KC_BSPC,  KC_ENT, KC_KP_0, KC_NO, _______, _______,
 ...
 */
    [_SYMBOLS] = LAYOUT_elora_hlc(
      ...
      KC_PERCENT,   KC_EXLM,  KC_AT , KC_LCBR, KC_RCBR ,KC_PIPE ,                                     _______, _______ , _______ ,  _______  , KC_ASTR , _______,
      KC_MINUS,    KC_AMPR,  KC_DLR, KC_LPRN, KC_RPRN, KC_GRAVE,                                     KC_LEFT, KC_DOWN , KC_UP   , KC_RIGHT  ,  _______, _______,
      KC_UNDS, KC_HASH, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILDE, _______, _______, _______, _______, KC_UNDS, KC_MINUS, KC_EQUAL, KC_PERCENT,  _______, _______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, _______,  _______, _______, _______,                                                       _______, _______, _______, _______, _______
    ),

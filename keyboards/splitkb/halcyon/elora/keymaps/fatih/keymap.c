 ...
 */
    [_SYMBOLS] = LAYOUT_elora_hlc(
      _______, _______, _______, _______, _______, _______,                                      KC_F1,   KC_F2   , ________,  _______  ,  ______, QK_BOOT,
      _______, KC_EXLM,  KC_AT , KC_LCBR, KC_RCBR ,KC_PIPE ,                                     _______, _______ , ________,  _______  , KC_ASTR, _______ ,
      _______, KC_AMPR,  KC_DLR, KC_LPRN, KC_RPRN, KC_GRAVE,                                     KC_LEFT, KC_DOWN , KC_UP   , KC_RIGHT  ,  ______, ______,
      _______, KC_HASH, KC_CIRC, KC_LBRC, KC_RBRC, KC_TILDE, _______, _______, _______, _______, KC_UNDS, KC_MINUS, KC_EQUAL, KC_PERCENT,  ______, ______,
                                 _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,
     _______, _______,  _______, _______, _______,                                                       _______, _______, _______, _______, _______
    ),

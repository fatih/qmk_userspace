 ...
 */
    [_QWERTY] = LAYOUT_elora_hlc(
     ...
     HYPR(KC_5),  KC_Z ,  KC_X   ,  KC_C  ,   KC_V ,            KC_B , OSM(MOD_LSFT), OSM(MOD_LALT),     OSM(MOD_RALT)  , OSM(MOD_RSFT), KC_N,   KC_M ,  KC_COMM, KC_DOT,  KC_SLSH, MACLOCK,
                                KC_ESC, KC_LEFT , KC_RIGHT,  KC_LGUI, KC_BSPC,                    KC_ENT ,LT(_SYMBOLS, KC_SPC), KC_DOWN, KC_UP, KC_ESC, KC_MUTE, KC_NO,  KC_NO, KC_NO, KC_NO,                                                                KC_MUTE, KC_NO, KC_NO, KC_NO, KC_NO),
